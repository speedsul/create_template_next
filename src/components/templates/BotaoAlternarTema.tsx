...
export default function BotaoAlternarTema(props: BotaoAlternarTemaProps) {
    return props.tema === 'dark' ? (
        <div
            ...
            className=" hidden sm:flex items-center bg-gradient-to-r from-yellow-300 to-yellow-600 w-14 lg:w-24 h-8 cursor-pointer p-1 rounded-full">
...
export type { BotaoAlternarTemaProps };
